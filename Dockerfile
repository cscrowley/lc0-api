...
RUN apt-get update && apt-get install -y wget unzip curl python3 python3-pip git cmake build-essential protobuf-compiler libprotobuf-dev libboost-all-dev && apt-get clean && rm -rf /var/lib/apt/lists/*
